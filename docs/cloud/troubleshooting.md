...
> **Note**, to have WebRTC metric data available for the Troubleshooting page, they need to be enabled for [player metrics](https://docs.nanocosmos.de/docs/cloud/analytics#webcaster).
